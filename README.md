...
1. What is the DOM?
    ...
    DOM is the Document Object Model that is the programming API for HTML and XML

2. What is an event?

    An event is something that happens within an HTML document
